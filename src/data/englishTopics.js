// This file contains the English topics and their subtopics for educational purposes.
export const ENGLISH_TOPICS = [
  {
    ...
    subtopics: [
      ...
      { name: "Errors", path: "/post-utme/english/errors" },
      { name: "Question", path: "/post-utme/english/question" }
    ]
  },
  {
    id: "vocabulary",
