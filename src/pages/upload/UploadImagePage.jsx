// src/pages/upload/UploadImagePage.jsx
...
export const UploadImagePage = () => {
  ...
  const handleGenerateQuestions = async (e) => {
    ...
    if (!extractedText.trim()) {
      setError('No text extracted from image.');
      return;
    }
      ...
      <div className="max-w-4xl w-full">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-3">
            Transform Images into Questions
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Snap or upload study materials to create practice questions instantly
          </p>
        </div>
