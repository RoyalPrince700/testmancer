...
export const EnglishQuiz = () => {
  ...
  // Process the imported topics to replace icon strings with components
  const initialTopics = englishQuizTopics.map(topic => ({
    ...topic,
    icon: iconComponents[topic.icon]
  }));
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        {firstName && isAuthenticated && (
          <motion.div
            ...
            className="bg-gradient-to-r from-teal-500 to-teal-700 rounded-2xl p-6 text-white text-center mb-10"
          >
