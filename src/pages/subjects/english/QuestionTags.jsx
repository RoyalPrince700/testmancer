...
import { QuestionTagPages as pages } from '../../../data/QuestionTagsPages';
...
const Question = () => (
  <LearningModule
    ...
    pages={pages}
    points={3}
    quizPath="/quiz-hub/english/quiz-question"
    backPath="/post-utme/english"
    badges={[
      { name: "Question Champion", color: "from-indigo-500 to-indigo-700" },
