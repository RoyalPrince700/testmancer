const questions = [
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "15m × 5m" },
      { id: 'b', text: "10m × 10m (a square)", correct: true },
      { id: 'c', text: "20m × 0m" },
      { id: 'd', text: "12m × 8m" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "It's like an odometer - showing total distance traveled" },
      { id: 'b', text: "It shows the starting position" },
      { id: 'c', text: "It's like a speedometer - showing rate of change at a moment", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "It's like a speedometer - showing speed at a moment" },
      { id: 'b', text: "It shows the acceleration" },
      { id: 'c', text: "It shows the direction of travel" },
      { id: 'd', text: "It's like an odometer - showing total accumulated distance", correct: true }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "Use integration to find the area" },
      { id: 'b', text: "Use the derivative to find the slope, then use point-slope form", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "A line parallel to the tangent line" },
      { id: 'b', text: "The same as the tangent line" },
      { id: 'c', text: "A horizontal line" },
      { id: 'd', text: "A line perpendicular to the tangent line", correct: true }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "8 square units" },
      { id: 'b', text: "14/3 square units", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "The area between two curves" },
      { id: 'b', text: "The slope of a tangent line" },
      { id: 'c', text: "The 3D volume formed when rotating a 2D shape around an axis", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "When the function equals zero" },
      { id: 'b', text: "When the derivative equals zero", correct: true },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: "Indefinite integrals are more accurate" },
      { id: 'c', text: "Definite integrals give exact numerical answers, indefinite give general formulas", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "3 units/second" },
      { id: 'b', text: "4 units/second" },
      { id: 'c', text: "5 units/second", correct: true },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'd', text: "Economics", correct: true }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "To calculate total distance" },
      { id: 'b', text: "To know the instantaneous direction of road curves", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "An approximate guess" },
      { id: 'b', text: "The slope at each point" },
      { id: 'c', text: "An exact formula for the total area", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "9 cubic units" },
      { id: 'b', text: "9π cubic units", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "It only works with constant values" },
      { id: 'b', text: "It's only useful for abstract mathematics" },
      { id: 'c', text: "It handles changing quantities and optimization", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "The function becomes undefined" },
      { id: 'b', text: "The slope becomes zero (horizontal tangent)", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "To count the number of objects" },
      { id: 'b', text: "To measure temperature" },
      { id: 'c', text: "To identify chemical elements" },
      { id: 'd', text: "To find velocity and acceleration from position", correct: true }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "The problem has no solution" },
      { id: 'b', text: "The function is undefined" },
      { id: 'c', text: "There are restrictions or limitations (like fixed perimeter)", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "To solve simple arithmetic" },
      { id: 'b', text: "To optimize real-world quantities like profit, cost, or efficiency", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "To count hospital beds" },
      { id: 'b', text: "To schedule appointments" },
      { id: 'c', text: "To model drug concentration changes in the body", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "The exact value of the function" },
      { id: 'b', text: "Whether a critical point is a maximum or minimum", correct: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "Employee names and addresses" },
      { id: 'b', text: "Office furniture colors" },
      { id: 'c', text: "Maximum revenue, minimum cost, optimal production levels", correct: true },
    ...
    options: [
      { id: 'a', text: "Height and weight" },
      { id: 'b', text: "Speed and distance traveled", correct: true },
    ...
    options: [
      { id: 'a', text: "To choose paint colors" },
      { id: 'b', text: "To optimize structural curves and minimize material usage", correct: true },
    ...
    options: [
      { id: 'a', text: "All functions are differentiable" },
      { id: 'b', text: "Integration is always harder than differentiation" },
      { id: 'c', text: "Differentiation and integration are inverse operations", correct: true },
    ...
    options: [
      { id: 'a', text: "To name different species" },
      { id: 'b', text: "To count trees in a forest" },
      { id: 'c', text: "To identify rock types" },
      { id: 'd', text: "To model population growth and pollution spread rates", correct: true }
    ],
    ...
    options: [
      { id: 'a', text: "It only works with whole numbers" },
      { id: 'b', text: "It avoids complex calculations" },
      { id: 'c', text: "It handles continuous change and finds optimal solutions", correct: true },
