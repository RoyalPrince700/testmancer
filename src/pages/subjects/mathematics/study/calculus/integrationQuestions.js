// Quiz questions for Integration
const questions = [
  {
    id: 1,
    text: "What is ∫x dx?",
    options: [
      { id: 'a', text: "x²/2 + C", correct: true },
      { id: 'b', text: "x² + C" },
      { id: 'c', text: "x + C" },
      { id: 'd', text: "1 + C" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "They are inverse operations", correct: true },
      { id: 'b', text: "They are the same operation" },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "x³/3 - 2x² + x + C", correct: true },
      { id: 'b', text: "2x - 4 + C" },
      { id: 'c', text: "x³ - 4x² + x + C" },
      { id: 'd', text: "x³/3 - 4x² + C" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "All possible vertical shifts of the antiderivative", correct: true },
      { id: 'b', text: "The area under the curve" },
      { id: 'c', text: "The slope of the function" },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "∫xⁿ dx = xⁿ⁺¹/(n+1) + C (n ≠ -1)", correct: true },
      { id: 'b', text: "∫xⁿ dx = nxⁿ⁻¹ + C" },
      { id: 'c', text: "∫xⁿ dx = xⁿ + C" },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "x³/3 + x² + x + C", correct: true },
      { id: 'b', text: "(x + 1)³/3 + C" },
      { id: 'c', text: "x² + 2x + 1 + C" },
      { id: 'd', text: "x³ + x² + x + C" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "Definite integrals have limits and give numbers; indefinite integrals give functions", correct: true },
      { id: 'b', text: "Definite integrals are harder to calculate" },
      { id: 'c', text: "Indefinite integrals don't exist" },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "Areas under curves", correct: true },
      { id: 'b', text: "Slopes of tangent lines" },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "x³ - 3x² + 2x + C", correct: true },
      { id: 'b', text: "6x - 6 + C" },
      { id: 'c', text: "3x³ - 6x² + 2x + C" },
      { id: 'd', text: "x³ - 6x² + 2x + C" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "s(t) = t³ + C", correct: true },
      { id: 'b', text: "s(t) = 6t + C" },
      { id: 'c', text: "s(t) = 3t² + C" },
      { id: 'd', text: "s(t) = 9t + C" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "Because there are infinitely many antiderivatives", correct: true },
      { id: 'b', text: "To make the answer look complete" },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "x⁴ - x² + 5x + C", correct: true },
      { id: 'b', text: "12x² - 2 + C" },
      { id: 'c', text: "4x⁴ - 2x² + 5x + C" },
      { id: 'd', text: "x⁴ - 2x² + 5x + C" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "The area between the curve and the x-axis from x = a to x = b", correct: true },
      { id: 'b', text: "The slope of the curve at x = b" },
      { id: 'c', text: "The maximum value of f(x)" },
      { id: 'd', text: "The length of the curve" }
    ],
  ...
  },
  {
    ...
    text: "What is ∫√x dx?",
    options: [
      { id: 'a', text: "(2/3)x^(3/2) + C", correct: true },
      { id: 'b', text: "(1/2)x^(1/2) + C" },
      { id: 'c', text: "x^(3/2) + C" },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "x³/3 + x²/2 - 2x + C", correct: true },
      { id: 'b', text: "x² + x - 2 + C" },
      { id: 'c', text: "(x - 1)(x + 2) + C" },
      { id: 'd', text: "x³ + x² - 2x + C" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "The Fundamental Theorem of Calculus", correct: true },
      { id: 'b', text: "The Mean Value Theorem" },
      { id: 'c', text: "L'Hôpital's Rule" },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "C(x) = 3x² + 5x + K", correct: true },
      { id: 'b', text: "C(x) = 6x + 5 + K" },
      { id: 'c', text: "C(x) = 6 + K" },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "It cancels out", correct: true },
      { id: 'b', text: "It doubles" },
      { id: 'c', text: "It becomes zero" },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: "It helps find areas, volumes, total accumulated quantities, and solve differential equations", correct: true },
      { id: 'b', text: "It makes calculations more complex" },
