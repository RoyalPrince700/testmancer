// src/pages/subjects/currentaffairs/study/nigerian-history/Colonial.jsx
import React from "react";
import { Link } from "react-router-dom";
import { FiBook } from "react-icons/fi";
import LearningModule from "../../CurrentLearningModule";
import { ColonialEraPage as pages } from './ColonialPages';
...
const Colonial = () => (
  <LearningModule
    ...
    subtopic="Colonial-Era"        // ✅ exact match with Supabase
    pages={pages}
    points={3}
    quizPath="/quiz-hub/current-affairs/colonial-quiz" // ✅ updated quiz path
