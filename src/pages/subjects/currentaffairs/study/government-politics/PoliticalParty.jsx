// src/pages/subjects/currentaffairs/study/nigerian-history/PoliticalParty.jsx
import React from "react";
import { Link } from "react-router-dom";
import { FiBook } from "react-icons/fi";
import LearningModule from "../../CurrentLearningModule";
import { PoliticalPartiesPage as pages } from './PoliticalPartyPages';
...
const PoliticalParty = () => (
  <LearningModule
    ...
    subtopic="Political-Parties"        // ✅ exact match with Supabase
    pages={pages}
    points={3}
    quizPath="/quiz-hub/current-affairs/political-party-quiz" // ✅ updated quiz path
