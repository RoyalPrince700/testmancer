// src/pages/subjects/currentaffairs/study/nigerian-history/Unilorin.jsx
import React from "react";
import { Link } from "react-router-dom";
import { FiBook } from "react-icons/fi";
import LearningModule from "../../CurrentLearningModule";
import { UniversityOfIlorinHistoryPage as pages } from './UnilorinPages';
...
const Unilorin = () => (
  <LearningModule
    ...
    subtopic="University-Of-Ilorin"        // ✅ exact match with Supabase
    pages={pages}
    points={3}
    quizPath="/quiz-hub/current-affairs/unilorin-quiz" // ✅ updated quiz path
